...
config.detectorList[0].name='PFS-B_1'
...
config.detectorList[1].name='PFS-B_2'
...
config.detectorList[2].name='PFS-B_3'
...
config.detectorList[3].name='PFS-B_4'
...
config.detectorList[4].name='PFS-R_1'
...
config.detectorList[5].name='PFS-R_2'
...
config.detectorList[6].name='PFS-R_3'
...
config.detectorList[7].name='PFS-R_4'
...
config.detectorList[8].name='PFS-N_1'
...
config.detectorList[9].name='PFS-N_2'
...
config.detectorList[10].name='PFS-N_3'
...
config.detectorList[11].name='PFS-N_4'
